          ...
          <div className="card-header">
            <div>
              ...
              {nextBooking ? (
                <>
                  <h5 className="text">
                    Customer Name : {nextBooking.customer_name}
                  </h5>
                  <p className="text-muted">
                    Time Slot : {nextBooking.time_slot}
                  </p>
                </>
              ) : (
          ...
          <div className="modal-box">
            ...
            <div className="form-step-wrapper text-start px-3">
              ...
              <div className="review-box mb-3">
                ...
                <p>
                  <strong>Name:</strong> {nextBooking.customer_name}
                </p>
                <p>
                  <strong>Phone:</strong> {nextBooking.phone_number}
                </p>
                {nextBooking.email && (
                  <p>
                    <strong>Email:</strong> {nextBooking.email}
                  </p>
                )}
                {nextBooking.address && (
                  <p>
                    <strong>Address:</strong> {nextBooking.address}
                  </p>
                )}
              </div>
              <div className="review-box mb-3">
                ...
                <p>
                  <strong>Date:</strong> {nextBooking.event_date}
                </p>
                <p>
                  <strong>Time Slot:</strong> {nextBooking.time_slot}
                </p>
              </div>
              ...
              <div className="review-box mb-3">
                ...
                {celebrationOptions.map(
                  (celebration) =>
                    Number(celebration.celebration_id) ===
                      Number(nextBooking.celebration_id) && (
              ...
              {(nextBooking.addons_note ||
                (nextBooking.additional_items &&
                  nextBooking.additional_items.length > 0)) && (
                <div className="review-box mb-3">
              ...
              <div className="review-box mb-3">
                ...
                <p>
                  ...
                  {nextBooking.payment_mode
                    ? nextBooking.payment_mode.replace("_", " ").toUpperCase()
                    : "N/A"}
                </p>
                <p>
                  <strong>Total Amount:</strong> ₹
                  {nextBooking.payment_total || "0"}
                </p>
                <p>
                  <strong>Amount Paid:</strong> ₹
                  {nextBooking.payment_paid || "0"}
                </p>
                <p>
                  <strong>Balance:</strong> ₹
                  {Math.max(
                    0,
                    (Number(nextBooking.payment_total) || 0) -
                      (Number(nextBooking.payment_paid) || 0)
                  )}
                </p>
                {nextBooking.payment_notes && (
                  <p>
                    <strong>Notes:</strong> {nextBooking.payment_notes}
                  </p>
                )}
              </div>
            </div>
